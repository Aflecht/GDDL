...
; the real SjASMPlus-assembled output, executed via the z80 PyPI
; library's bare-CPU emulation (breakpoint-based, register/memory
; inspection at each step -- see run_z80_test.py).
...
ActionAttack_ranged_weapon_Handler:
	...
	include "generated_z80_minimal.asm"
