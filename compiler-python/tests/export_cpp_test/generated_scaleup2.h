...
{
    inline constexpr Item ItemViaFullReplace = { Object{ 10, 20 }, 5, Element::fire, "Sword" };
    inline constexpr Item ItemViaBareModify = { Object{ 99, 100 }, 7, Element::ice, "AAAAAAAAAAAAAAA" };
    inline constexpr Item ItemCopy = { Object{ 10, 20 }, 50, Element::lightning, "Shield" };
}
