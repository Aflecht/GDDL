...
struct Enemy
{
    ...
    std::array<std::array<char, 16>, 4>   names;
};

namespace Enemy_Instances
{
    inline constexpr Enemy BaseGoblin = { { 10, 30 }, {{ { 1, 2, 3 }, { 4, 5, 6 } }}, {{ { "Alice" }, { "Bob" }, { "Carol, Jr." }, { "Dave" } }} };
    inline constexpr Enemy StrongerGoblin = { { 10, 80 }, {{ { 1, 2, 3 }, { 4, 5, 6 } }}, {{ { "Alice" }, { "Bob" }, { "Carol, Jr." }, { "Dave" } }} };
}
...
namespace Enemy_Registry
{
    ...
    {
        Entry{ 0x3a8e66ab429d7ffcULL, "StrongerGoblin", &Enemy_Instances::StrongerGoblin },
        Entry{ 0x4ee3563a6adda595ULL, "BaseGoblin", &Enemy_Instances::BaseGoblin },
    };
